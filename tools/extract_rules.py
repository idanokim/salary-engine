...
HISTORICAL_RATES = {
    4934: [0.047, 0.05],                              # הסכם 2009: עד 1.2013 → 4.7%
    4994: [0.0225, 0.04, 0.0625, 0.0725],             # הסכם 2011: מדרגות 2011–7.2013
    ...
    5533: [0.02, 0.0394, 0.035],                      # תוספת 2024: שלב 1.2024 → 2%; מינהלי 3.94%, מח"ר 3.5% (per droog-darga)
